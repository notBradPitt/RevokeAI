...
#
# Adapted for use in RevokeAI by Lincoln Stein, July 2023
#
...
logger = RevokeAILogger.getLogger(__name__)
CONVERT_MODEL_ROOT = RevokeAIAppConfig.get_config().models_path / "core/convert"
...
def stable_unclip_image_encoder(original_config):
    ...
    if sd_clip_image_embedder_class == "ClipImageEmbedder":
        ...
        feature_extractor = CLIPImageProcessor()
        # RevokeAI doesn't use CLIPVisionModelWithProjection so it isn't in the core - if this code is hit a download will occur
