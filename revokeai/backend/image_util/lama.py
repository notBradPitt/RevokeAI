...
from revokeai.app.services.config import get_revokeai_config
from revokeai.backend.util.devices import choose_torch_device
...
class LaMA:
    def __call__(self, input_image: Image.Image, *args: Any, **kwds: Any) -> Any:
        ...
        model_location = get_revokeai_config().models_path / "core/misc/lama/lama.pt"
