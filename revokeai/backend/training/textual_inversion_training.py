...
# on January 2, 2023
# and modified slightly by Lincoln Stein (@lstein) to work with RevokeAI
...
# revokeai stuff
from revokeai.app.services.config import RevokeAIAppConfig, PagingArgumentParser
from revokeai.app.services.model_manager_service import ModelManagerService
from revokeai.backend.model_management.models import SubModelType
...
def do_textual_inversion_training(
    ...
    **kwargs,
    ...
    # setting up things the way revokeai expects them
