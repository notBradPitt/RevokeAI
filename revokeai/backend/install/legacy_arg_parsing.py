# Copyright 2023 Lincoln D. Stein and the RevokeAI Team
...
# in order to be able to parse both 2.0 and 3.0-pre-nodes versions of revokeai.init
SAMPLER_CHOICES = [
    "ddim",
    "ddpm",
    "deis",
...
general_group.add_argument("--version", "-V", action="store_true", help="Print RevokeAI version number")
model_group.add_argument(
    "--root_dir",
    default=None,
    help='Path to directory containing "models", "outputs" and "configs". If not present will read from environment variable REVOKEAI_ROOT. Defaults to ~/revokeai.',
)
model_group.add_argument(
    "--config",
    "-c",
