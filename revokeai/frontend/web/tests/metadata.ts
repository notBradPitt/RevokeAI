...
// #     parsed_metadata = metadata_service._parse_revokeai_metadata(valid_metadata)
...
// #     parsed_metadata = metadata_service._parse_revokeai_metadata(
...
// #     parsed_metadata = metadata_service._parse_revokeai_metadata(metadata_missing_node)
// #     assert expected == parsed_metadata
...
// #     parsed_metadata = metadata_service._parse_revokeai_metadata(metadata_invalid_node)
// #     assert expected == parsed_metadata
...
// #     parsed_metadata = metadata_service._parse_revokeai_metadata(metadata_no_node_attrs)
// #     assert expected == parsed_metadata
...
// #     parsed_metadata = metadata_service._parse_revokeai_metadata(metadata_array_attr)
// #     assert expected == parsed_metadata
