...
export type paths = {
  ...
  "/api/v1/sessions/{session_id}/revoke": {
     ...
     */
    put: operations["revoke_session"];
    /**
     * Cancel Session Revoke
     * @description Revokes a session
     */
    delete: operations["cancel_session_revoke"];
  };
  "/api/v1/models/": {
    /**
     * List Models
...
export type components = {
  schemas: {
    ...
    /**
     * CoreMetadata
     * @description Core generation metadata for an image generated in RevokeAI.
     */
    CoreMetadata: {
      /**
       * App Version
       * @description The version of RevokeAI used to generate this image
       * @default 3.1.1rc1
       */
      app_version?: string;
      /**
    ...
    /**
     * LoRAMetadataField
     * @description LoRA metadata for an image generated in RevokeAI.
     */
    LoRAMetadataField: {
      /**
       * Lora
...
export type operations = {
  ...
  revoke_session: {
    parameters: {
      query?: {
        /** @description Whether or not to revoke all remaining invocations */
        all?: boolean;
      };
      path: {
    ...
    responses: {
      ...
      /** @description The session has no invocations ready to revoke */
      400: {
        content: never;
      };
      /** @description Session not found */
