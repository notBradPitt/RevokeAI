...
import { RevokeTabName, tabMap } from 'features/ui/store/tabMap';
...
export interface RevokeTabInfo {
  id: RevokeTabName;
...
export const NO_GALLERY_TABS: RevokeTabName[] = ['modelManager'];
export const NO_SIDE_PANEL_TABS: RevokeTabName[] = ['modelManager'];
...
export default memo(RevokeTabs);
