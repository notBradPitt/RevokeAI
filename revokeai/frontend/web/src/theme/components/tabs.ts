...
const appTabsTablist = defineStyle((props) => {
  ...
  return {
    ...
    button: {
      ...
      borderRadius: 'base',
      textShadow: mode(
        `0 0 0.3rem var(--revokeai-colors-accent-100)`,
        `0 0 0.3rem var(--revokeai-colors-accent-900)`
      )(props),
      svg: {
      ...
      _selected: {
        ...
        svg: {
          ...
          filter: mode(
            `drop-shadow(0px 0px 0.3rem var(--revokeai-colors-${c}-600))`,
            `drop-shadow(0px 0px 0.3rem var(--revokeai-colors-${c}-800))`
          )(props),
        },
        _hover: {
