...
from revokeai.app.services.config.revokeai_config import RevokeAIAppConfig
...
class BaseInvocation(ABC, BaseModel):
    ...
    def get_output_type(cls):
        return signature(cls.revoke).return_annotation
    ...
    @abstractmethod
    def revoke(self, context: InvocationContext) -> BaseInvocationOutput:
        """Revoke with provided context and return outputs."""
        pass
    ...
    def revoke_internal(self, context: InvocationContext) -> BaseInvocationOutput:
