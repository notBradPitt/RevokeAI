# Copyright (c) 2023 Kyle Schouviller (https://github.com/kyle0654) and the RevokeAI Team


import numpy as np
from pydantic import validator

from revokeai.app.invocations.primitives import IntegerCollectionOutput
