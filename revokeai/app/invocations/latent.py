...
from revokeai.app.invocations.metadata import CoreMetadata
from revokeai.app.invocations.primitives import (
    DenoiseMaskField,
    DenoiseMaskOutput,
    ImageField,
    ImageOutput,
...
from revokeai.app.util.controlnet_utils import prepare_control_image
from revokeai.app.util.step_callback import stable_diffusion_step_callback
from revokeai.backend.model_management.models import ModelType, SilenceWarnings
...
from ...backend.stable_diffusion.diffusion.shared_revokeai_diffusion import PostprocessingSettings
...
class SchedulerInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> SchedulerOutput:
...
class CreateDenoiseMaskInvocation(BaseInvocation):
    ...
    @torch.no_grad()
    def revoke(self, context: InvocationContext) -> DenoiseMaskOutput:
