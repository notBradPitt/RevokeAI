...
from revokeai.app.invocations.controlnet_image_processors import ControlField
from revokeai.app.invocations.model import LoRAModelField, MainModelField, VAEModelField
...
class LoRAMetadataField(BaseModelExcludeNull):
    """LoRA metadata for an image generated in RevokeAI."""
...
class CoreMetadata(BaseModelExcludeNull):
    """Core generation metadata for an image generated in RevokeAI."""

    app_version: str = Field(default=__version__, description="The version of RevokeAI used to generate this image")
...
class MetadataAccumulatorInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> MetadataAccumulatorOutput:
