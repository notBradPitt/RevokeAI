...
from revokeai.app.invocations.primitives import ConditioningField, ConditioningOutput, ImageField, ImageOutput
from revokeai.app.util.step_callback import stable_diffusion_step_callback
from revokeai.backend import BaseModelType, ModelType, SubModelType
...
class OnnxModelLoaderInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> ONNXModelLoaderOutput:
