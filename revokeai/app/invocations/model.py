...
class MainModelLoaderInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> ModelLoaderOutput:
...
class LoraLoaderInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> LoraLoaderOutput:
...
class SDXLLoraLoaderInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> SDXLLoraLoaderOutput:
        if self.lora is None:
            raise Exception("No LoRA provided")
...
class VaeLoaderInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> VaeLoaderOutput:
...
class SeamlessModeInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> SeamlessModeOutput:
