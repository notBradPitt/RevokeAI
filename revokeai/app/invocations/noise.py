# Copyright (c) 2023 Kyle Schouviller (https://github.com/kyle0654) & the RevokeAI Team


import torch
from pydantic import validator

from revokeai.app.invocations.latent import LatentsField
...
class NoiseInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> NoiseOutput:
        noise = get_noise(
            width=self.width,
            height=self.height,
