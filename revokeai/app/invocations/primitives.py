...
class BooleanInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> BooleanOutput:
...
class BooleanCollectionInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> BooleanCollectionOutput:
...
class IntegerInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> IntegerOutput:
...
class IntegerCollectionInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> IntegerCollectionOutput:
...
class FloatInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> FloatOutput:
...
class FloatCollectionInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> FloatCollectionOutput:
...
class StringInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> StringOutput:
...
class StringCollectionInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> StringCollectionOutput:
...
class ImageCollectionInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> ImageCollectionOutput:
...
class LatentsInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> LatentsOutput:
...
class LatentsCollectionInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> LatentsCollectionOutput:
...
class ColorInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> ColorOutput:
...
class ConditioningInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> ConditioningOutput:
...
class ConditioningCollectionInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> ConditioningCollectionOutput:
