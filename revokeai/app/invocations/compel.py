...
from revokeai.app.invocations.primitives import ConditioningField, ConditioningOutput
from revokeai.backend.stable_diffusion.diffusion.shared_revokeai_diffusion import (
...
from ...backend.stable_diffusion.diffusion import RevokeAIDiffuserComponent
...
class CompelInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> ConditioningOutput:
        ...
        with ModelPatcher.apply_lora_text_encoder(
            ...
            ec = RevokeAIDiffuserComponent.ExtraConditioningInfo(
...
class ClipSkipInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> ClipSkipInvocationOutput:
