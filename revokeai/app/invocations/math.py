...
from revokeai.app.invocations.primitives import FloatOutput, IntegerOutput
...
class IntegerMathInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> IntegerOutput:
        # Python doesn't support switch statements until 3.10, but RevokeAI supports back to 3.9
