...
async def add_image_to_board(
    ...
    try:
        result = ApiDependencies.revoker.services.board_images.add_image_to_board(
...
async def remove_image_from_board(
    ...
    try:
        result = ApiDependencies.revoker.services.board_images.remove_image_from_board(image_name=image_name)
        return result
    except Exception:
...
async def add_images_to_board(
    ...
    try:
        ...
        for image_name in image_names:
            try:
                ApiDependencies.revoker.services.board_images.add_image_to_board(
                    board_id=board_id, image_name=image_name
                )
...
async def remove_images_from_board(
    ...
    try:
        ...
        for image_name in image_names:
            try:
                ApiDependencies.revoker.services.board_images.remove_image_from_board(image_name=image_name)
