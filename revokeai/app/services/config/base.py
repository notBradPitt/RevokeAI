...
"""
Base class for the RevokeAI configuration system.
...
class RevokeAISettings(BaseSettings):
    """
    ...
    def to_yaml(self) -> str:
        ...
        as the contents of `revokeai.yaml` to restore settings later.
        """
        cls = self.__class__
    ...
    def _excluded_from_yaml(self) -> List[str]:
        # combination of deprecated parameters and internal ones that shouldn't be exposed as revokeai.yaml options
        return [
            "type",
            "initconf",
            "version",
