...
class GraphInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> GraphInvocationOutput:
        """Revoke with provided services and return outputs."""
...
class IterateInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> IterateInvocationOutput:
...
class CollectInvocation(BaseInvocation):
    ...
    def revoke(self, context: InvocationContext) -> CollectInvocationOutput:
        """Revoke with provided services and return outputs."""
