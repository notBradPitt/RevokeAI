...
from revokeai.backend.image_util import retrieve_metadata

if len(sys.argv) < 2:
    print("Usage: file2prompt.py <file1.png> <file2.png> <file3.png>...")
    print("This script opens up the indicated revoke.py-generated PNG file(s) and prints out their metadata.")
    exit(-1)
