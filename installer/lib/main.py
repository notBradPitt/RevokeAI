...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default=os.environ.get("REVOKEAI_ROOT") or "~/revokeai",
    )
    parser.add_argument(
        "-y",
        "--yes",
    ...
    parser.add_argument(
        "--version",
        dest="version",
        help="Version of RevokeAI to install. Default to the latest stable release. A special 'pre' value will install the latest published pre-release version.",
        default=None,
    )
