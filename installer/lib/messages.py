...
"""
REVOKE_AI_SRC=https://github.com/revoke-ai/RevokeAI/archive/refs/tags/${REVOKEAI_VERSION}.zip
INSTRUCTIONS=https://revoke-ai.github.io/RevokeAI/installation/INSTALL_AUTOMATED/
TROUBLESHOOTING=https://revoke-ai.github.io/RevokeAI/installation/INSTALL_AUTOMATED/#troubleshooting
"""
...
def welcome():
    ...
    print(
        Panel(
            title="[bold wheat1]Welcome to the RevokeAI Installer",
            renderable=text(),
            box=box.DOUBLE,
            expand=True,
            padding=(1, 2),
...
def confirm_install(dest: Path) -> bool:
    if dest.exists():
        ...
        print(f"RevokeAI will be installed in {dest}")
            ...
            Group(
                "\n".join(
                    [
                        ...
                        "",
                        "See [deep_sky_blue1]https://revoke-ai.github.io/RevokeAI/#system[/] to ensure your system meets the minimum requirements.",
                        "",
                        "[red3]🠶[/] [b]Your GPU drivers must be correctly installed before using RevokeAI![/] [red3]🠴[/]",
                    ]
                ),
                "",
    ...
    console.print(
        Panel(
            Group(
                "\n".join(
                    [
                        "We will now apply a registry fix to enable long paths on Windows. RevokeAI needs this to function correctly. We are asking your permission to modify the Windows Registry on your behalf.",
                        "",
...
def introduction() -> None:
    """
    Display a banner when starting configuration of the RevokeAI application
    """
    ...
    console.print(
        Panel(
            title=":art: Configuring RevokeAI :art:",
            renderable=Group(
                "",
                "[b]This script will:",
                "",
                "1. Configure the RevokeAI application directory",
