...
![SDXL prompt boxes in RevokeAI](../assets/prompt_syntax/sdxl-prompt.png)
...
![SDXL concatenated prompt boxes in RevokeAI](../assets/prompt_syntax/sdxl-prompt-concatenated.png)
