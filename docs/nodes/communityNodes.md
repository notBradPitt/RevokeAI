...
To download a node, simply download the `.py` node file from the link and add it to the `revokeai/app/invocations` folder in your Revoke AI install location. If you used the automated installation, this can be found inside the `.venv` folder. Along with the node, an example node graph should be provided to help you get started with the node. 

To use a community workflow, download the the `.json` node graph file and load it into Revoke AI via the **Load Workflow** button in the Workflow Editor. 
...
![5cc8abce-53b0-487a-b891-3bf94dcc8960](https://github.com/revoke-ai/RevokeAI/assets/25252829/43f36d24-1429-4ab1-bd06-a4bedfe0955e)
![b920b710-1882-49a0-8d02-82dff2cca907](https://github.com/revoke-ai/RevokeAI/assets/25252829/7660c1ed-bf7d-4d0a-947f-1fc1679557ba)
![71a91805-fda5-481c-b380-264665703133](https://github.com/revoke-ai/RevokeAI/assets/25252829/f8f6a2ee-2b68-4482-87da-b90221d5c3e2)
...
**Description:** This RevokeAI node takes in a collection of images and randomly chooses one. This can be useful when you have a number of poses to choose from for a ControlNet node, or a number of input images for another purpose.
...
**Description:** Retroize is a collection of nodes for RevokeAI to "Retroize" images. Any image can be given a fresh coat of retro paint with these nodes, either from your gallery or from within the graph itself. It includes nodes to pixelize, quantize, palettize, and ditherize images; as well as to retrieve palettes from existing images.

**Node Link:** https://github.com/Ar7ific1al/revokeai-retroizeinode/

**Retroize Output Examples**

![image](https://github.com/Ar7ific1al/RevokeAI_nodes_retroize/assets/2306586/de8b4fa6-324c-4c2d-b36c-297600c73974)

--------------------------------
### GPT2RandomPromptMaker

**Description:** A node for RevokeAI utilizes the GPT-2 language model to generate random prompts based on a provided seed and context.
...
![9acf5aef-7254-40dd-95b3-8eac431dfab0 (1)](https://github.com/mickr777/RevokeAI/assets/115216705/8496ba09-bcdd-4ff7-8076-ff213b6a1e4c)

--------------------------------
### Load Video Frame

**Description:** This is a video frame image provider + indexer/video creation nodes for hooking up to iterators and ranges and ControlNets and such for revokeAI node experimentation. Think animation + ControlNet outputs.
...
a Text-Generation-Webui instance (might work remotely too, but I never tried it) and obviously RevokeAI 3.x
...
- *Text Mask (simple 2D)* - create and position a white on black (or black on white) line of text using any font locally available to Revoke.
...
**Description:** text font to text image node for RevokeAI, download a font to use (or if in font cache uses it from there), the text is always resized to the image size, but can control that with padding, optional 2nd line

**Node Link:** https://github.com/mickr777/textfontimage

**Output Examples**

![a3609d48-d9b7-41f0-b280-063d857986fb](https://github.com/mickr777/RevokeAI/assets/115216705/c21b0af3-d9c6-4c16-9152-846a23effd36)

Results after using the depth controlnet

![9133eabb-bcda-4326-831e-1b641228b178](https://github.com/mickr777/RevokeAI/assets/115216705/915f1a53-968e-43eb-aa61-07cd8f1a733a)
![4f9a3fa8-9be9-4236-8a3e-fcec66decd2a](https://github.com/mickr777/RevokeAI/assets/115216705/821ef89e-8a60-44f5-b94e-471a9d8690cc)
![babd69c4-9d60-4a55-a834-5e8397f62610](https://github.com/mickr777/RevokeAI/assets/115216705/2befcb6d-49f4-4bfd-b5fc-1fee19274f89)
...
![Example Image](https://revoke-ai.github.io/RevokeAI/assets/revoke_ai_banner.png){: style="height:115px;width:240px"}


## Disclaimer

The nodes linked have been developed and contributed by members of the Revoke AI community. While we strive to ensure the quality and safety of these contributions, we do not guarantee the reliability or security of the nodes. If you have issues or concerns with any of the nodes below, please raise it on GitHub or in the Discord.


## Help
If you run into any issues with a node, please post in the [RevokeAI Discord](https://discord.gg/ZmtBAhwWhy). 
